...
const Reports = () => {
  ...
  const downloadCSV = () => {
    ...
    const logoRow = 'LOGO,,,,,,';
    const emptyRow = ',,,,,,';
    const headerRow = 'S/N,Employee Name ,Role,Shift,Breaks Taken,Total Time (sec),Status';
    const dataRows = report.staffStats.map((s, idx) => [
      idx + 1,
      s.name,
      s.role,
      s.shift,
    ...
    const csv = [logoRow, emptyRow, emptyRow, emptyRow, headerRow, ...dataRows].join('\n');
